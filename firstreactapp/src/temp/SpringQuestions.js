...
class SpringQuestions extends React.Component {
    constructor() {
        super();
        this.state = {
            questions: [],
    ...
    componentDidMount() {
        ...
        axios.all([
            axios.get("http://localhost:8082/quizApp/questionapi/springQuestions"),
            axios.get("http://localhost:8082/quizApp/questionapi/springAnswers"),
            axios.get("http://localhost:8082/quizApp/questionapi/springQuizId")
        ...
        return (
            <React.Fragment>
                  <div className="time">
                    ...
                    <div class='questions' >
                    <Card style={{ width:'50rem',marginBottom:'1%', marginLeft:'16%'}}>
...
export default SpringQuestions;